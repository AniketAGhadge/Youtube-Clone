  ...
  return (
    <div className='grid grid-flow-col p-2 m-2'>
      ...
      <div className='flex col-span-10'>
        <div className='flex'>
          <input className='fixed w-1/2 border border-gray-400 rounded-l-full' type='text' 
        ...
        <div className=' bg-white px-2 py-2 w-[37rem] shadow-lg rounded-lg' >
          <ul>
            {searchResult.map((s)=> (<li key={s} className='py-2 px-3 shadow-sm hover:bg-gray-100'>
              🔍 {s}
            </li>))}
          </ul>
        </div>
