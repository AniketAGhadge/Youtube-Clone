    ...
    <div className="p-2 m-2 col-span-1">
      <div className="flex p-1">
        <img
          className="h-8"
          alt="Home"
          src="https://logowik.com/content/uploads/images/795_home.jpg"
        />
        <Link to="/">Home</Link>
      </div>
      <div className="flex p-1">
      ...
      <div className="flex p-1">
        <img
          className="h-8"
          alt="Libery"
          src="https://cdn3.iconfinder.com/data/icons/video-33/24/video_library_movie_film-512.png"
        />
      ...
      <div className="flex p-1">
        <img
          className="h-8"
          alt="History"
          src="https://img.uxwing.com/wp-content/themes/uxwing/download/time-date-calendar/history-icon.png"
        />
      ...
      <div className="flex p-1">
        <img
          className="h-8"
          alt="Your Videos"
          src="https://cdn4.iconfinder.com/data/icons/social-media-line-3/64/Social-media-expand_Youtube-512.png"
        />
      ...
      <div className="flex p-1">
        <img
          className="h-8"
          alt="Watch Later"
          src="https://static.thenounproject.com/png/106663-200.png"
        />
      ...
      <div className="flex p-1">
        <img
          className="h-8"
          alt="Love Songs"
          src="https://icon-library.com/images/song-icon-png/song-icon-png-27.jpg"
        />
